...
parser.add_argument(
    "--optim", type=str, default="SGD", help="optimizer to use (default: SGD)"
)
parser.add_argument(
    "--nhid",
    type=int,
...
parser.add_argument(
    "--validseqlen", type=int, default=320, help="valid sequence length (default: 320)"
)
parser.add_argument(
    "--seq_len",
    type=int,
...
parser.add_argument(
    "--dataset", type=str, default="ptb", help="dataset to use (default: ptb)"
)
        ...
        if batch_idx % args.log_interval == 0 and batch_idx > 0:
            ...
            print(
                ...
                "loss {:5.3f} | bpc {:5.3f}".format(
                    epoch,
                    batch_idx,
                    int((source_len - 0.5) / args.validseqlen),
                    lr,
